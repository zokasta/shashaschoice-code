...
class Goldsmith_Woo_Grid extends Widget_Base {
    use Goldsmith_Helper;
    public function get_name() {
        return 'goldsmith-woo-grid';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'col',
            [
                ...
                'max' => 6,
                'default' => 4,
                'selectors' => ['{{WRAPPER}} .goldsmith-products.row>.col,{{WRAPPER}} .goldsmith-products.row>div' => '-ms-flex: 0 0 calc(100% / {{VALUE}} );flex: 0 0 calc(100% / {{VALUE}} );width: calc(100% / {{VALUE}} );']
            ]
        );
        $this->add_control('column_gap',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .goldsmith-products.row>.col,{{WRAPPER}} .goldsmith-products.row>div' => 'padding: 0 {{SIZE}}px;margin-bottom: {{SIZE}}px;',
    ...
    protected function render() {
        ...
        echo '<div class="section-custom-categories '.$settings['grid_style'].'">';
