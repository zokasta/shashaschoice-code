...
* Library api class
*
* @package GoldsmithAddons
* @author GoldsmithMonster
*/
...
class Library_Source extends Source_Base {
    ...
    */
    const LIBRARY_CACHE_KEY = 'goldsmith_library_cache';
    ...
    */
    const API_TEMPLATES_INFO_URL = 'https://elementories.com/goldsmith/wp-content/template-library/info.json';

    /**
    * Template data api url
    */
    const API_TEMPLATE_DATA_URL = 'https://elementories.com/goldsmith/wp-content/template-library/templates/';

    public function get_id() {
        return 'goldsmith-library';
    }

    public function get_title() {
        return __( 'Goldsmith Library', 'goldsmith' );
    }
    ...
    */
    ...
    public static function request_template_data( $template_id ) {
        ...
        $body = [
            ...
            'version' => GOLDSMITH_PLUGIN_VERSION,
        ];
        /*
        if ( goldsmith_has_pro() ) {
            $body['has_pro'] = 1;
            $body['pro_version'] = GOLDSMITH_PLUGIN_VERSION;
        }
        */
    ...
    */
    public function get_data( array $args, $context = 'display' ) {
        ...
        if ( empty( $data ) || empty( $data['content'] ) ) {
            throw new \Exception( __( 'Template does not have any content', 'goldsmith' ) );
        }
