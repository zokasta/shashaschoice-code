...
function ninetheme_admin_menu() {
    ...
    */
    ...
    $parent_title = esc_html__( 'NineTheme', 'goldsmith' );
    $icon         = 'dashicons-chart-pie';
    $main_panel   = 'ninetheme_panel';
    // Submenu page
    $sub_title1   = sprintf( '%s %s',esc_html__( 'About ', 'goldsmith' ), $theme_name );
    $sub_slug     = 'ninetheme_about_page';
    // Submenu page
    $sub_title2   = esc_html__( 'Theme Activation', 'goldsmith' );
...
function ninetheme_panel() {
            ...
            <div class="c-row">
                ...
                <div class="c-md-5 c-content">
                    <div class="c-inner">
                        ...
                        <h2 class="c-title"><?php esc_html_e( 'Support', 'goldsmith' ); ?></h2>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Help Center', 'goldsmith' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/support/"><?php esc_html_e( 'Help Center', 'goldsmith' ); ?></a>

                        <p class="c-text"><?php esc_html_e( 'If you need support with using the theme,
                        please visit the links below. If you are having trouble with the installation, please read the documentation.', 'goldsmith' ); ?></p>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Theme Documentations', 'goldsmith' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/docs/elementor-themes-documentation/"><?php esc_html_e( 'Theme Elementor Documentation', 'goldsmith' ); ?></a>
                        <a class="c-link" target="_blank" href="https://ninetheme.com/docs/elementor-themes-documentation/"><?php esc_html_e( 'Theme WPBakery Documentation', 'goldsmith' ); ?></a>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Plugin Documentations', 'goldsmith' ); ?></h4>
                        <a class="c-link" target="_blank" href="https://elementor.com/help/how-to-use-elementor/"><?php esc_html_e( 'Elementor General Documentation', 'goldsmith' ); ?></a>
                        <a class="c-link" target="_blank" href="https://kb.wpbakery.com/"><?php esc_html_e( 'WPBakery General Documentation', 'goldsmith' ); ?></a>
                        <a class="c-link" target="_blank" href="https://docs.pluginize.com/category/126-custom-post-type-ui/"><?php esc_html_e( 'CPTUI General Documentation', 'goldsmith' ); ?></a>
                        <a class="c-link" target="_blank" href="https://contactform7.com/docs/"><?php esc_html_e( 'Contact Form 7 General Documentation', 'goldsmith' ); ?></a>

                        <br>
                        <br>
                        <h4 class="c-title"><?php esc_html_e( 'Follow Us', 'goldsmith' ); ?></h4>
                    ...
                    <div class="c-inner">
                        ...
                        if ( isset( $_POST['ninetheme_deactivate_licence'] ) ) {
                            wp_remote_post('https://api.ninetheme.com/deactivate', array(
                                ...
                                'body' => array(
                                    'purchase_code' => trim( get_option('envato_purchase_code_42570063') ),
                            ...
                            if ( get_option('envato_purchase_code_42570063') ) {
                                delete_option('envato_purchase_code_42570063');
                            }
                        }

                        if ( false == get_option('envato_purchase_code_42570063') ) {
                            update_option( 'ninetheme_deactivated_licence', 'yes' );
                            ?>
                            <h4 class="c-title"><?php esc_html_e( 'Activate License', 'goldsmith' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'Envato allows 1 license for 1 project located on 1 domain. It means that 1 purchase key can be used only for 1 site. Each additional site will require an additional purchase key.', 'goldsmith' ); ?></p>
                            <p class="c-text"><?php esc_html_e( 'Please click to connect your license and enter your purchase code.', 'goldsmith' ); ?></p>
                            ...
                            <form class="connect-licence-form" method="post" action="<?php echo admin_url('admin.php?page=merlin&step=license'); ?>">
                                <button type="submit" class="button button-primary ninetheme-connect-licence" name="ninetheme_connect_licence">
                                    <?php esc_html_e( 'CONNECT', 'goldsmith' ); ?>
                                </button>
                            </form>
                            ...
                            <h4 class="c-title"><?php esc_html_e( 'Disconnect License', 'goldsmith' ); ?></h4>
                            <p class="c-text"><?php esc_html_e( 'If you want to use this template on another server, click the disconnect button here. When you disconnect, this creates a registration and a list of domains for which you used the purchase code will be saved. In case of illegal use of licenses, there is a risk that your Envato account will be deleted or your purchase code will be canceled. Do not share your license code with anyone other than our support team.', 'goldsmith' ); ?></p>
                            ...
                            <form class="deactivate-form" method="post">
                                <button type="submit" class="button button-primary ninetheme-deactivate-licence" name="ninetheme_deactivate_licence">
                                    <?php esc_html_e( 'Disconnect', 'goldsmith' ); ?>
                                </button>
                            </form>
                            <?php
                        }
    ...
    <style>
        ...
        input#goldsmith_disconnection1 {
            margin: 0;
            margin-right: 10px;
        }
