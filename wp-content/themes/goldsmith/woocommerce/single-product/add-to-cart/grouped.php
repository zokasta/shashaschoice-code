...
<div class="goldsmith-summary-item goldsmith-product-info">
	<div class="goldsmith-product-info-top">
		<form class="goldsmith-flex cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		    ...
		    <?php if ( $quantites_required && $show_add_to_cart_button ) : ?>
		        ...
		        <div class="goldsmith-after-cart-grouped-button-wrapper">
		            <button
		            type="submit"
		            ...
		            <div class="goldsmith-after-cart-button-wrapper">
